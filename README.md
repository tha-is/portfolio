...
---
<img src="/assets/print.png" align="center"/> <img src="/assets/Color Hunt Palette.png" align="center">
...
- [Personalizar READ.me](https://www.youtube.com/watch?v=TsaLQAetPLU)
- [Paleta de cores - Color Hunt](https://colorhunt.co/palette/f6f6f6ffbb91ff8e6e515070)
- [Header - Canva](https://www.canva.com/design/DAG3CwALaNw/TSZux-wVFY6RkBH6PgyfBQ/edit?utm_content=DAG3CwALaNw&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)
- [Google Fonts](https://fonts.google.com/)
- [Box-shadow & Button - Get CSS Scan](https://getcssscan.com/)

### 🛠️ Instruções de execução

Para utilizar o layout, faça um git clone em seu repositório e altere as partes editáveis, como descrições, nome de contato e imagens, caso não queira reutilizar.
